...
export function CinematicHero({
  ...
  cardHeading = "Apps, engineered end-to-end.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">Trafy AI</span> designs, builds, and ships native-feel iOS and
      Android apps — architecture, backend, and launch, handled by one accountable team.
    </>
  ),
  metricValue = 120,
  metricLabel = "Apps Shipped",
  ctaHeading = "Let's build your app.",
  ctaDescription = "Tell us what you're building — we'll scope it, design it, and ship it.",
  ctaPrimaryLabel = "Start a Project",
  ctaSecondaryLabel = "See App Work",
  className,
  ...props
}: CinematicHeroProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-screen h-screen overflow-hidden flex items-center justify-center bg-[#05060a] text-[#f4f5fb] font-body antialiased", className)}
      style={{ perspective: "1500px" }}
      {...props}
    >
      <div className="film-grain-dark" aria-hidden="true" />
      <div className="bg-grid-theme-dark absolute inset-0 z-0 pointer-events-none opacity-50" aria-hidden="true" />
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform">
        <h1 className="text-track gsap-reveal font-display text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tight mb-2 text-white/90 [text-shadow:0_10px_30px_rgba(197,254,55,0.12),0_2px_4px_rgba(0,0,0,0.4)]">
          {tagline1}
        </h1>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight text-silver-matte">{ctaHeading}</h2>
        <p className="text-white/55 text-lg md:text-xl mb-12 max-w-xl mx-auto font-light leading-relaxed">{ctaDescription}</p>
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#contact" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] font-display font-semibold focus:outline-none focus:ring-2 focus:ring-signal focus:ring-offset-2 focus:ring-offset-[#05060a]">
            {ctaPrimaryLabel}
          </a>
          <a href="#work" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] font-display font-semibold focus:outline-none focus:ring-2 focus:ring-signal focus:ring-offset-2 focus:ring-offset-[#05060a]">
            {ctaSecondaryLabel}
          </a>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md font-display">Trafy</span>
                        </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="88" cy="88" r="64" fill="none" stroke="#C5FE37" strokeWidth="12" />
                        </svg>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">App Launched</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Live on both stores</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Sprint Shipped</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Deployed to prod</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              <h3 className="text-white text-2xl md:text-3xl lg:text-4xl font-bold mb-0 lg:mb-5 tracking-tight font-display">{cardHeading}</h3>
