...
export function ServiceCaseStudy({ config }: { config: ServiceConfig }) {
  ...
  return (
    <section id="case-study" className="px-gutter py-section bg-secondary/40">
      <div className="mx-auto max-w-5xl">
        <Reveal>
          <span className="text-caption uppercase tracking-[0.2em] text-accent-element">
            {caseStudy.industry}
          </span>
          <h2 className="mt-4 font-display text-h2 text-foreground max-w-2xl">{caseStudy.client}</h2>
        ...
        <Reveal delay={0.2}>
          <blockquote className="mt-16 max-w-2xl border-l-2 border-accent-element pl-6 font-display text-h3 text-foreground">
