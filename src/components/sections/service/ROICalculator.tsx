...
export function ROICalculator({ config }: { config: ServiceConfig }) {
  ...
  return (
    <section id="roi-calculator" className="px-gutter py-section bg-secondary/40">
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div className="flex flex-col gap-8">
              <div>
                ...
                <input
                  ...
                  className="mt-3 w-full accent-accent-element focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-element rounded"
                />
              </div>
            ...
            <div className="rounded-xl border border-border bg-background p-8 lg:p-10">
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <div className="font-display text-h1 text-accent-element leading-none">
