        ...
        <div className="mx-auto max-w-5xl">
          ...
          <section aria-labelledby="about-hero-heading">
            <Reveal className="max-w-3xl">
              ...
              <h1 id="about-hero-heading" className="mt-4 font-display text-display-l text-foreground">
                {about.hero.headline}
              </h1>
            ...
            <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-6">
              {pillars.map((pillar, i) => (
                <Reveal key={pillar.headline} delay={i * 0.1}>
                  <h3 className="font-display text-h2 text-foreground">{pillar.headline}</h3>
          ...
          >
            <Reveal>
              ...
              <h2 id="about-approach-heading" className="mt-4 font-display text-h2 text-foreground">
                How We Work
              </h2>
            </Reveal>
          ...
          >
            <Reveal className="mx-auto max-w-xl text-center">
              ...
              <h2 id="about-cta-heading" className="mt-4 font-display text-h2 text-foreground">
